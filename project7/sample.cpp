...
InitLists( )
{
	...
	// do this for yourself...
		glColor3f( .5f, .5f, 0. );	// 0. <= r,g,b <= 1.
		glPushMatrix( );
			glTranslatef( 1000.f, 500.f, 0.f );
			glutWireSphere( 500.f, 100, 100 ); //0., -800., 0.,  500
		glPopMatrix( );


		glColor3f( .5f, .5f, 0. );	// 0. <= r,g,b <= 1.
		glPushMatrix( );
			glTranslatef( 300.f, 100.f, 0.f );
			glutWireSphere( 100.f, 100, 100 ); //0., -800., 0.,  500
		glPopMatrix( );
